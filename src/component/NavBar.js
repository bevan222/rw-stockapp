            ...
            <Collapse in={navbarItemOpen}>
                <div className="navbar-collapse" id="navbarList">
                    <ul className="navbar-nav mr-auto">
                        ...
                        >
                            <li className="nav-item">
                                <a className="nav-link" target="_blank" href="https://www.tpex.org.tw/web/bulletin/trading_date/trading_date.php?l=zh-tw">市場開休市</a>
                            </li>
                            <li className="nav-item">
                                <a className="nav-link" target="_blank" href="https://www.tpex.org.tw/web/stock/exright/decap/decap.php?l=zh-tw">減資預告表</a>
                            </li>
                            <li className="nav-item">
                                <a className="nav-link" target="_blank" href="https://www.tpex.org.tw/web/bulletin/attention_information/trading_attention_information.php?l=zh-tw">注意股</a>
                            </li>
                            <li className="nav-item">
                                <a className="nav-link" target="_blank" href="https://www.tpex.org.tw/web/bulletin/disposal_information/disposal_information.php?l=zh-tw">處置股</a>
                            </li>
                            <li className="nav-item">
                                <a className="nav-link" target="_blank" href="https://www.tpex.org.tw/web/stock/exright/preAnnounce/PrePost.php?l=zh-tw">除權息</a>
                            </li>
                        </NavDropdown>
                    </ul>
                    {/* 
